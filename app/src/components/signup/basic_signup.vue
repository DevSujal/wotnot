<template>
  ...
  <!-- CAPTCHA removed: Turnstile widget intentionally disabled to allow direct signup -->
...
export default {
  ...
  mounted() {
    // Turnstile script intentionally NOT included. CAPTCHA removed to allow direct signup.
  },
  methods: {
    handleSubmit() {
      // CAPTCHA removed — do not require a token client-side
      const formData = {
